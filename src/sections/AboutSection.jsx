        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            <div className="lg:col-span-4">
              <h2 className="text-sm font-sans uppercase tracking-[0.3em] text-gray-500 mb-6 border-b border-dark-border pb-4">
                About The Developer
              </h2>
            </div>
            <div className="lg:col-span-8">
              <h3 className="text-3xl md:text-5xl font-display font-medium text-white leading-tight mb-12 mix-blend-normal">
                I craft digital experiences that combine <span className="text-gray-500 italic">aesthetic precision</span> with technical excellence.
              </h3>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-gray-400 font-sans text-lg leading-relaxed">
                <p>
                  As a B.Sc IT student and frontend specialist, I focus on the MERN stack to build applications that don't just function perfectly, but feel incredible to use.
                </p>
                <p>
                  My approach merges modern creative development—using tools like GSAP, WebGL, and React—with robust architecture to deliver award-worthy web experiences.
                </p>
              </div>
            </div>
          </div>
